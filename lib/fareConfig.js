...
export const VEHICLE_FARES = {
  Sedan: { perKm: 14, driverAllowance: 400, label: 'SEDAN' },
  Etios: { perKm: 14, driverAllowance: 400, label: 'ETIOS' },
  SUV: { perKm: 19, driverAllowance: 400, label: 'SUV' },
  Innova: { perKm: 19, driverAllowance: 400, label: 'INNOVA' },
  Crysta: { perKm: 22, driverAllowance: 400, label: 'CRYSTA' },
};
