...
export const pageSeo = {
  home: (() => {
    ...
    return {
      ...
      description:
        "TamilNadu Drop Taxi is Tamil Nadu's trusted drop taxi service since 2015. Safe, affordable cabs across all 38 districts. Book outstation, airport, and city rides online.",
      keywords,
      keywordsContent,
      searchKeywords,
    };
  ...
  cities: (() => {
    ...
    return {
      ...
      description:
        'TamilNadu Drop Taxi serves major cities and towns across Tamil Nadu. Find drop taxi and cab service coverage for your route and district.',
      keywords,
      keywordsContent,
      searchKeywords,
    };
